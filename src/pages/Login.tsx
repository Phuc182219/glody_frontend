          ...
          >
            {showPassword ? (
              ...
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.293-3.95M6.7 6.7A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-4.043 5.112M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path d="M3 3l18 18" />
              </svg>
            )}
          </button>
        ...
        <div className="flex justify-center gap-8 w-full mb-6">
          <button className="">
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
              <path d="M16.365 1.43c-.36-.36-.86-.56-1.37-.56-.51 0-1.01.2-1.37.56-.36.36-.56.86-.56 1.37 0 .51.2 1.01.56 1.37.36.36.86.56 1.37.56.51 0 1.01-.2 1.37-.56.36-.36.56-.86.56-1.37 0-.51-.2-1.01-.56-1.37z" />
            </svg>
          </button>
          <button className="">
            <svg className="w-8 h-8" viewBox="0 0 48 48">
              <g>
                ...
                <path
                  fill="#4285F4"
                  d="M34.6 24.2c0-.7-.1-1.4-.2-2H24v4.1h6c-.3 1.5-1.3 2.7-2.7 3.5v2.9h4.4c2.6-2.4 4.1-5.9 4.1-9.5z"
                />
                <path
                  fill="#34A853"
                  d="M24 36c2.4 0 4.4-.8 5.9-2.1l-4.4-2.9c-1.2.8-2.7 1.3-4.3 1.3-3.3 0-6.1-2.2-7.1-5.2h-4.5v3.2C12.9 33.8 18.1 36 24 36z"
                />
                <path
                  fill="#FBBC05"
                  d="M16.9 27.1c-.3-.8-.5-1.7-.5-2.6s.2-1.8.5-2.6v-3.2h-4.5C11.2 21.1 10.9 22.5 10.9 24s.3 2.9.9 4.3l4.5-3.2z"
                />
                <path
                  fill="#EA4335"
                  d="M24 17.9c1.3 0 2.5.4 3.4 1.2l2.6-2.6C29.1 14.8 27.1 14 24 14c-5.9 0-11.1 2.2-14.6 5.8l4.5 3.2c1-3 3.8-5.2 7.1-5.2z"
                />
          ...
          <button className="">
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#1877F3">
